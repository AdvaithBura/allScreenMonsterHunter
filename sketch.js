...
var ball, ball1, ball2, ball3, sphereImg, bText1, bText2, bText3, speed,highScore, bText5, TW,TH, backImg
var gameState = 1;
var arrowState = 1;
var thePosition = 1;
var healthText = 30;
...
function setup(){
    ...
    imageMode(CENTER);
    player = createSprite(TW/2,TH-170,100,150);
...
if(gameState === 4){
  ...
  text("Cost: all remaining money", TW/2.5,150);
  textSize(40);
  text("Money:"+ Money, TW/2.5,TH-50);

 
  text("YOU LOSE", TW/2.5,50);
